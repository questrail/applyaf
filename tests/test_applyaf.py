...
class TestReadingCSVFiles():
    def test_reading_spectrum_analyzer_readings(self, analyzer_readings, known_analyzer_readings):
...
class TestApplyAntennaFactors():
    def test_applying_antenna_factor(self, analyzer_readings, antenna_factors, cable_losses, known_incident_field):
    ...
    def test_applying_then_removing_antenna_factor(self, given_analyzer_readings, antenna_factors, cable_losses):
        calculated_incident_field = applyaf.apply_antenna_factor(
    ...
    def test_applying_antenna_factor_without_cable_loss(self, my_data_type, analyzer_readings, antenna_factors):
